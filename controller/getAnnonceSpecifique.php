...
if(isset($_SESSION['titrePost'])){
    $allExp=Annonces::getAnnonceSpecifique();
    $out='';
    if(sizeof($allExp)>0){
        foreach ($allExp as $exp){
            $out.= '<div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p style="color:#000" class="text-center"><a href="annonces.php?'.ID_USER.'='.$_SESSION['id'].'&tsdgjsdvysdjhsgdhsfdy='.md5($_SESSION['pseudo']).'&annonce='.$exp['idAnnonce'].'">'.utf8_encode($exp['intitulePost']).'</a><br>
    ...
    echo '<p class="text-info text-center"> Aucune annonce qui vous conserne</p>';
}
